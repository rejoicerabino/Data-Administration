...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 28, 2024 at 06:58 AM
...
INSERT INTO `userinfo` (`userInfoID`, `userID`, `addressID`, `firstName`, `lastName`, `bio`, `age`) VALUES
(1, 1, 1, 'Bethel', 'Pamplona', 'Hindi kumpleto childhood mo kung hindi ka naging bata.', 22),
(2, 2, 2, 'Xharl', 'Luna', 'The man who can\'t be moved. ', 18),
(3, 3, 3, 'Daniella', 'Biscocho', 'Basta pogi ang guy, maaga akong bibigay. \r\n#kith\'sproperty', 20),
(4, 4, 4, 'Emron', 'Pamplona', 'Akala ko love story na, toy story pala!', 21),
(5, 5, 1, 'Kith', 'Austria', 'Hindi ako si natoy pero mahal na mahal kita asdjfkgkl\r\n#dan\'sproperty', 21),
(6, 6, 3, 'Rhica', 'Rabino', 'Walang time sa tropa pero pag sau ay talaga naman!', 30),
(7, 7, 2, 'Reji', 'Montes', 'let the pain teach you how to dougie.', 20);
...
--
ALTER TABLE `userinfo`
  MODIFY `userInfoID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
