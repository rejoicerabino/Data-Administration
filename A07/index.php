...
if (isset($_POST['btnDeleteMember'])) {
    $id = $_POST['id'];
    $deleteQuery = "UPDATE userinfo SET isDeleted = 1 WHERE userInfoID = '$id'";
    executeQuery($deleteQuery);
}

$query = "SELECT * FROM userinfo WHERE isDeleted = 0";
...
<body>
                        ...
                        <div class="card my-3">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle mb-2 text-muted">
                                    <?php echo htmlspecialchars($row['age']) . ' years old'; ?>
                                </h6>
                                <p class="card-text"><?php echo htmlspecialchars($row['bio']); ?></p>
                                <form method="post">
                                    <input type="hidden" value="<?php echo $row['userInfoID']; ?>" name="id">
                                    <button class="btn btn-delete" name="btnDeleteMember">Remove</button>
                                </form>
                                <a href="view.php?id=<?php echo $row['userInfoID']; ?>">
                                    <button class="btn btn-edit my-2">Edit</button>
                                </a>
        ...
        <form method="post" class="member-form">
            <div class="container px-3">
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <button type="submit" name="btnSubmitMember" class="btn btn-primary w-40"
                            style="background-color: #608BC1; color: white; border: none; cursor: pointer; transition: background-color 0.3s ease;"
                            onmouseover="this.style.backgroundColor='#536493'"
                            onmouseout="this.style.backgroundColor='#608BC1'">
                            Submit
                        </button>
                    </div>
                </div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-5ow4X4IM9diQj3Xk8i/xDq9O5FQ58Af0A1qg1LO1k2zvlgNzmZFRbaZAKld04OYk" crossorigin="anonymous"></script>
</body>
