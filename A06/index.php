...
<body>
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="card my-3">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-subtitle mb-2 text-muted"><?php echo htmlspecialchars($row['age']) . ' years old'; ?></h6>
                                    <p class="card-text"><?php echo htmlspecialchars($row['bio']); ?></p>
                                    <form method="post">
                                        <input type="hidden" value="<?php echo $row['userInfoID']; ?>" name="id">
                                        <button class="btn btn-delete" name="btnDeleteMember">Delete</button>
                                    </form>
                                </div>
                            </div>
                        </div>
    ...
    <footer class="container-fluid py-3" style="background-color: #181C14;">
        <ul class="nav justify-content-center" 
            style="border-bottom: 2px solid #F6F5F2; padding-bottom: 3px; margin-bottom: 3px; width: calc(100% - 80px); margin-left: 40px;">
            <li class="nav-item">
                <a class="nav-link" href="#" style="color: white">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#" style="color: white">Tuscany</a>
            </li>
            <li class="nav-item">
